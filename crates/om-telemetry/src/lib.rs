...
//!
//! [`UsageReporter`]: om_core::ports::UsageReporter
//! [`UsageInfo`]: om_core::usage::UsageInfo

use std::time::Duration;

use async_trait::async_trait;
use om_core::ports::UsageReporter;
use om_core::usage::UsageInfo;
use om_core::CoreResult;
    ...
    async fn report(&self, info: &UsageInfo) -> CoreResult<()> {
        ...
        match self
            ...
            .header(
                ...
                concat!("om/", env!("CARGO_PKG_VERSION")),
            )
            .json(&body)
            .send()
            .await
